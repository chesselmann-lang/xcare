    ...
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-sm">
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          zwischen der xcare Pflegemarktplatz GmbH (nachfolgend „xcare") und
          den Nutzern der Plattform unter{" "}
      ...
      <section className="mb-8">
        ...
        <p className="mt-2">
          ...
          lediglich den Kontakt zwischen Anbietern und Familien. xcare
          übernimmt keine Verantwortung für die Qualität der vermittelten
          Dienstleistungen.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          und xcare unverzüglich über missbräuchliche Nutzung zu informieren.
        </p>
        <p className="mt-2">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <li>
            keine irreführenden oder rechtswidrigen Inhalte einzustellen.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          Die Basisnutzung von xcare ist für Familien kostenlos. Anbieter
          können zwischen verschiedenen Abonnement-Modellen wählen, deren
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          Bewertungen müssen wahrheitsgemäß sein und dürfen keine
          beleidigenden, diskriminierenden oder unwahren Aussagen enthalten.
          xcare behält sich das Recht vor, Bewertungen zu moderieren und bei
