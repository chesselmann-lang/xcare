  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold">Leistung bearbeiten</h1>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                name="name"
                required
                defaultValue={leistung.name}
                placeholder="z.B. Ambulante Pflege nach SGB XI"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <select
                ...
                name="kategorie"
                required
                defaultValue={leistung.kategorie}
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                name="beschreibung"
                rows={3}
                defaultValue={leistung.beschreibung ?? ""}
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="sgb_paragraf"
                name="sgb_paragraf"
                defaultValue={leistung.sgb_paragraf ?? ""}
                placeholder="z.B. SGB XI §36"
              />
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  defaultValue={leistung.kapazitaet ?? ""}
                  placeholder="z.B. 10"
                />
              </div>
              <div clas