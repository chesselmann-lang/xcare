    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      {visible.length === 0 ? (
        <div className="text-center py-16 text-[--muted-foreground]">
          ...
          <p className="text-sm">Neuigkeiten zu Ihren Anfragen erscheinen hier.</p>
        </div>
      ) : (
              ...
              >
                ...
                <ItemWrapper item={item}>
                  <div className="group">
                    ...
                    {item.link && (
                      <p className="text-xs text-[--primary] mt-1.5 flex items-center gap-0.5 group-hover:underline">
